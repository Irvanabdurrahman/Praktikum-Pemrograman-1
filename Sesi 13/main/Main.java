...
import service.RencanaStudi;
import service.RencanaStudiDetail;
import service.StatusRencanaStudiDetail;
...
public class Main {
    public static void main(String[] xx){
        ...
        r1.setNpm("4510210003");
        r1.setNama("Irvan Abdurrahman");
        r1.setIpk(3.2);
        r1.setSemester(3);
		...
		System.out.println("Nama    : Irvan Abdurrahman | 4510210003");
		System.out.println("Tanggal : 07 Desember 2011");
		System.out.println("Program : Rencana Studi Mahasiswa");
		System.out.println("___________________________________________\n");
